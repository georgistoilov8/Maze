...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
		...
		//[SerializeField] private float m_MoveSpeedMouse = 1f;                      // How fast the rig will move to keep up with the target's position.
		[Range(0f, 10f)] [SerializeField] private float m_TurnSpeedMouse = 1.5f;   // How fast the rig will rotate from user input.
		...
		private void HandleRotationMovement()
		{
			...
			m_LookAngle += x*m_TurnSpeedMouse;
			...
			else
			{
				...
				m_TiltAngle -= y*m_TurnSpeedMouse;
